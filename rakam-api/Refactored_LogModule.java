...
public class LogModule extends RakamModule {
    ...
    protected void setup(Binder binder) {
        ...
        if (logConfig.getLogActive()) {
            initializeSentry(logConfig, projectConfig);
        }
    }
    ...
    private void initializeSentry(
        ...
        if (projectConfig.getCompanyName() != null) {
            Sentry.getStoredClient()
                    .setEnvironment(projectConfig.getCompanyName());
        }

        Sentry.getStoredClient()
                .setRelease(RakamClient.RELEASE);

        Sentry.getStoredClient()
                .setServerName(HOST_NAME);

        Sentry.init(
                logConfig.getSentryUri()
                        + "?stacktrace.app.packages=org.rakam"
        );
    }
    ...
    public static class LogConfig {
        ...
        private static final String PUBLIC_SENTRY_DSN =
                "https://76daa36329be422ab9b592ab7239c2aa@sentry.io/1290994";
